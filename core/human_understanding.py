...
HUMAN_INTENTS = [
    ...
    IntentSignature("security", "security",
        primary=["security", "firewall", "vulnerability", "audit", "port", "threat"],
        secondary=["check", "scan", "open ports", "listener", "protect", "malware", "virus", "patch"],
        strong_indicators=["security check", "security audit", "check security", "scan ports"],
        phrase_patterns=["check security", "audit system", "scan for vulnerabilities", "check firewall"]),
